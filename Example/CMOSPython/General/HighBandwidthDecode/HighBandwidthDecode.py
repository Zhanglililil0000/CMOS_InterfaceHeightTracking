...
if __name__ == "__main__":
    try:
        ...
        ret = cam.MV_CC_GetPayloadSize(nDevPayloadSize, nMemAlignment)
        if 0 != ret:
        ...
        for i in range(0, nImageNum):
            ...
            if None != stOutFrame.pBufAddr and 0 == ret:
                ...
                file_path = "Image_w%d_h%d_fn%d.bmp" %(stDecodeParam.nWidth,stDecodeParam.nHeight, stOutFrame.stFrameInfo.nFrameNum)
